...
chacha_encrypt_bytes(chacha_ctx *x,const u8 *m,u8 *c,u32 bytes)
{
  ...
  for (;;) {
    ...
    x0 = XOR(x0,U8TO32_LITTLE(taskM + 0));
    x1 = XOR(x1,U8TO32_LITTLE(taskM + 4));
    x2 = XOR(x2,U8TO32_LITTLE(taskM + 8));
    x3 = XOR(x3,U8TO32_LITTLE(taskM + 12));
    x4 = XOR(x4,U8TO32_LITTLE(taskM + 16));
    x5 = XOR(x5,U8TO32_LITTLE(taskM + 20));
    x6 = XOR(x6,U8TO32_LITTLE(taskM + 24));
    x7 = XOR(x7,U8TO32_LITTLE(taskM + 28));
    x8 = XOR(x8,U8TO32_LITTLE(taskM + 32));
    x9 = XOR(x9,U8TO32_LITTLE(taskM + 36));
    x10 = XOR(x10,U8TO32_LITTLE(taskM + 40));
    x11 = XOR(x11,U8TO32_LITTLE(taskM + 44));
    x12 = XOR(x12,U8TO32_LITTLE(taskM + 48));
    x13 = XOR(x13,U8TO32_LITTLE(taskM + 52));
